...
import pandas as pd
from estxgnn.collectors import DrugBundleAggregator
from estxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from estxgnn.collectors.drug_bundle import PredictedIndication
    from estxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from estxgnn.collectors.drug_bundle import DrugBundle
