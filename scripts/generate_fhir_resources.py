...
BASE_URL = "https://estxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "estxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "ESTxGNNFHIRServer",
        "title": "ESTxGNN FHIR Server - Spain Drug Repurposing",
        "description": "FHIR R4 server for Spain TxGNN drug repurposing predictions",
        "status": "active",
